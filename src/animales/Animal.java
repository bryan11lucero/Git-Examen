...
public abstract class Animal {
     ...
     * La cadena deberá de seguir el siguiente formato: - Un número de dos cifras que represente el día del mes. 
     * Si el día solo tiene una cifra, deberá ponerse un 0 delante. Ejemplo: 01 - Un guión (-) o una barra (/) para separar el día del mes. 
     * - Un número de dos cifras que represente el mes del año, entre 1 y 12. Si el número del mes solo tiene una cifra, deberá ponerse un 0 delante. 
    ...
    public Animal(String codigo, String fechaNacimiento, char sexo, double peso) {
        ...
        if (!codigo.matches("[0-9a-z]{5}") || (sexo != 'M' && sexo != 'H') || (peso <= 0)) {
            ...
            try {
                ...
                /**
                 *  IllegalArgumentException: Si alguno de los argumentos no cumple con las condiciones establecidas para ser considerados correctos
                 */
                throw new IllegalArgumentException();
            }
            this.codigo = codigo;
